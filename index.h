...
const char* MAIN_page = R"=====(
  ...
  <body>
   <center>
    ...
    <input class="slider" id="scaleValue" type="range" min="1" max="100" step="1" oninput="sendScale()"/>
    <br/>
    <div id="grid">
      ...
      <input type="button" value="Sin Wave ON" id="sinbrightwave" class="btn">
      <input type="button" value="Chasing Raibow ON" id="chaserainbow" class="btn">
      <input type="button" value="One Color ON" id="onecolorall" class="btn">
    </div>
    <br/>
  ...
  <script>
    ...
    const sinbrightwaveButton = new Button('sinbrightwave');
    const chaserainbowButton = new Button('chaserainbow');
    const onecolorallButton = new Button('onecolorall');
